...
| [`soia-pkm-clip-wechat`](./skills/soia-pkm-clip-wechat/) | WeChat Official Account articles → vault | 🟡 SKILL.md ready, scraping script still to be generated by AI | None |
| [`soia-pkm-clip-web`](./skills/soia-pkm-clip-web/) | Generic web pages/blogs → vault | 🟡 same as above | Python `trafilatura` |
| [`soia-pkm-clip-drive`](./skills/soia-pkm-clip-drive/) | Cloud-drive PDF/Word → vault | 🟡 same as above | Python `pypdf`/`python-docx` |
