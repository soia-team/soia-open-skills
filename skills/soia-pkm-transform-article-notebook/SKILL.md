---
name: soia-pkm-transform-article-notebook
description: 把文章转换为试卷、闪卡、脑图、播客、学习笔记等 NotebookLM 类产物，或本地 Markdown 输出。Triggers：「生成试卷」「做成闪卡」「生成脑图」「做播客」「上传 NotebookLM」「generate quiz」「make flashcards」「mindmap」「podcast」
---

# soia-pkm-transform-article-notebook
...
```bash
npx skills add soia-team/soia-open-skills -g -a '*' -s soia-pkm-transform-article-notebook -y
```
