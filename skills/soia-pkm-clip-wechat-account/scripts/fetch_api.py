#!/usr/bin/env python3
"""
fetch_api.py — Route A (官方 API) for soia-pkm-clip-wechat-account.
...
SOIA_PKM_CLIP_WECHAT_ACCOUNT_CONFIG_FILE / skill-specific config.yml (see scripts/clip_gzh_env.py)
