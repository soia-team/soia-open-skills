...
生成 PPT / 长图 / 信息图 / 海报 / 封面图 / 视觉报告前，必须先读取 [references/design-prompts.md](references/design-prompts.md)，再按目标产物读取对应独立 prompt：
...
- 封面图 / 插画 / 背景素材：[references/prompt-imagegen.md](references/prompt-imagegen.md)
- 视觉报告：[references/prompt-report.md](references/prompt-report.md)
- NotebookLM artifact：[references/prompt-notebooklm.md](references/prompt-notebooklm.md)
