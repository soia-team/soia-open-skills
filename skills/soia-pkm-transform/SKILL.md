...
生成 PPT / 长图 / 信息图 / 海报 / 封面图 / 视觉报告前，必须读取 [references/design-prompts.md](references/design-prompts.md)，按目标产物选择对应 prompt。不要只写「总结成 PPT / 生成图片」这类宽泛提示词；先建立信息架构、视觉方向、负向约束和 QA 标准，再生成产物。
