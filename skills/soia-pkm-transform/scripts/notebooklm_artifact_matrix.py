...
TARGETS: dict[str, dict[str, Any]] = {
    ...
    "ppt": {
        ...
        "prompt": "生成简体中文可编辑 slide deck。保留文章结构、案例、术语关系和操作流程；不要做短摘要。",
    ...
    "report": {
        "generate": ["generate", "report", "--format", "study-guide"],
        "prompt": "生成简体中文 study guide，保留来源证据、术语解释、学习路径和待核实边界。",
        "download": ["download", "report", "report.md", "--force"],
        "kind": "text",
    },
    "data-table": {
        "generate": ["generate", "data-table"],
        "prompt": "提取文章中的关键概念、定义、例子、工具、风险，生成结构化对照表。",
