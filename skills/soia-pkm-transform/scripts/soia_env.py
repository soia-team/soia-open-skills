...
OVERRIDE_CONFIG_NAME = "SOIA_PKM_TRANSFORM_CONFIG_FILE"
OVERRIDE_ENV_NAME = "SOIA_PKM_TRANSFORM_ENV_FILE"
DEFAULT_CONFIG_FILE = "~/.config/soia-skills/soia-open-skills/soia-pkm/soia-pkm-transform/config.yml"
