...
```bash
npx skills add soia-team/soia-open-skills -g -a '*' -s soia-pkm-organize-article-moc -y
```

配置约定：

```text
~/.config/soia-skills/soia-open-skills/soia-pkm/soia-pkm-organize-article-moc/config.yml
