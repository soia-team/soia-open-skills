...
```bash
npx skills add soia-team/soia-open-skills -g -a '*' -s soia-pkm-distill-article-opinion -y
```

配置约定：

```text
~/.config/soia-skills/soia-open-skills/soia-pkm/soia-pkm-distill-article-opinion/config.yml
