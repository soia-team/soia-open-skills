...
| Antigravity CLI | `AGENTS.md` / `GEMINI.md` | 保留现有规则文件；全局技能位于 `~/.gemini/antigravity-cli/skills/`，workspace 技能位于 `.agents/skills/` |
...
- Codex → `~/.codex/skills/`
- Antigravity CLI → 全局 `~/.gemini/antigravity-cli/skills/`；workspace `.agents/skills/`
...
| AI CLI | Codex / Claude Code / Gemini CLI / Antigravity CLI / opencode / workbuddy | 推荐 | 多 AI 直接操作 vault |
