...
```bash
npx skills add soia-team/soia-open-skills -g -a '*' -s soia-pkm-translate-article-zh -y
```
...
```text
~/.config/soia-skills/soia-open-skills/soia-pkm/soia-pkm-translate-article-zh/config.yml
