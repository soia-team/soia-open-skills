#!/usr/bin/env python3
"""Static contract tests for soia-meta-prompt-clarity."""
...
SKILL_ROOT = REPO_ROOT / "skills" / "soia-meta-prompt-clarity"
...
class MetaPromptClaritySkillTests(unittest.TestCase):
