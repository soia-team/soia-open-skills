#!/usr/bin/env python3
"""
fetch_cookie.py — Route B (登录态 Cookie) for soia-pkm-clip-wechat-account.
...
WECHAT_COOKIE / WECHAT_APPMSG_TOKEN, loaded from SOIA_PKM_CLIP_WECHAT_ACCOUNT_CONFIG_FILE /
